...
const it: Catalog = {
  ...
  'decodifica.locked.title': 'Per decodificare serve l’autorizzazione',
  ...
  'decodifica.locked.notLoggedIn': 'Accedi o crea un account: serve un’identità per registrare l’autorizzazione.',
  ...
  'decodifica.locked.bearerLabel': 'Chiave MHC Bearer',
...
const en: Catalog = {
  ...
  'decodifica.locked.title': 'Authorisation required to decode',
  'decodifica.locked.description': 'Pay €20 once. Decoding stays unlocked forever, on every browser where you are signed in.',
  'decodifica.locked.notLoggedIn': 'Sign in or create an account — an identity is required to register the authorisation.',
  ...
  'decodifica.locked.bearerLabel': 'MHC Bearer key',
  'decodifica.locked.bearerPlaceholder': 'mhc_live_…',
...
const de: Catalog = {
  ...
  'decodifica.locked.title': 'Genehmigung zum Dekodieren erforderlich',
  ...
  'decodifica.locked.notLoggedIn': 'Melden Sie sich an oder erstellen Sie ein Konto — eine Identität ist zur Registrierung der Genehmigung erforderlich.',
  ...
  'decodifica.locked.bearerLabel': 'MHC Bearer-Schlüssel',
  'decodifica.locked.bearerPlaceholder': 'mhc_live_…',
...
const fr: Catalog = {
  ...
  'decodifica.locked.title': 'Autorisation requise pour décoder',
  ...
  'decodifica.locked.notLoggedIn': 'Connectez-vous ou créez un compte — une identité est nécessaire pour enregistrer l\'autorisation.',
  ...
  'decodifica.locked.bearerLabel': 'Clé MHC Bearer',
  'decodifica.locked.bearerPlaceholder': 'mhc_live_…',
