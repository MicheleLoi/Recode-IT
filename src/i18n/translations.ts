...
const it: Catalog = {
  ...
  'wireframe.mappa.server.cta': 'Sblocca per 25 euro / una tantum',
  ...
  'wireframe.modal.upsell.status': 'Non ancora sbloccato',
  'wireframe.modal.upsell.priceLead': 'Sblocca per',
  'wireframe.modal.upsell.priceAmount': '25 euro / una tantum',
  'wireframe.modal.upsell.details': 'Pagamento una sola volta, niente abbonamento. Sblocca cross-device sync, backup automatico, e accesso dal browser di casa, ufficio, mobile.',
  'wireframe.modal.upsell.cta': 'Sblocca ora',
...
const en: Catalog = {
  ...
  'wireframe.mappa.server.cta': 'Unlock for 25 euro / one-time',
  ...
  'wireframe.modal.upsell.status': 'Not yet unlocked',
  'wireframe.modal.upsell.priceLead': 'Unlock for',
  'wireframe.modal.upsell.priceAmount': '25 euro / one-time',
  'wireframe.modal.upsell.details': 'One-time payment, no subscription. Unlocks cross-device sync, automatic backup, and access from your home, office, mobile browser.',
  'wireframe.modal.upsell.cta': 'Unlock now',
...
const de: Catalog = {
  ...
  'wireframe.mappa.server.cta': 'Für 25 Euro freischalten / einmalig',
  ...
  'wireframe.modal.upsell.status': 'Noch nicht freigeschaltet',
  'wireframe.modal.upsell.priceLead': 'Freischalten für',
  'wireframe.modal.upsell.priceAmount': '25 Euro / einmalig',
  'wireframe.modal.upsell.details': 'Einmalige Zahlung, kein Abo. Schaltet geräteübergreifende Synchronisation, automatisches Backup und Zugriff aus Heim-, Büro- und Mobilbrowsern frei.',
  'wireframe.modal.upsell.cta': 'Jetzt freischalten',
...
const fr: Catalog = {
  ...
  'wireframe.mappa.server.cta': 'Débloquer pour 25 euros / une seule fois',
  ...
  'wireframe.modal.upsell.status': 'Pas encore débloqué',
  'wireframe.modal.upsell.priceLead': 'Débloquer pour',
  'wireframe.modal.upsell.priceAmount': '25 euros / une seule fois',
  'wireframe.modal.upsell.details': "Paiement unique, pas d'abonnement. Débloque la synchronisation cross-device, la sauvegarde automatique, et l'accès depuis les navigateurs maison, bureau et mobile.",
  'wireframe.modal.upsell.cta': 'Débloquer maintenant',
