...
const it: Catalog = {
  ...
  'wireframe.modal.upsell.parkedNotice': 'Il piano Pro non è ancora attivo. Scrivici (loimichele@gmail.com) se vuoi accesso anticipato.',
...
const en: Catalog = {
  ...
  'wireframe.modal.upsell.parkedNotice': 'The Pro plan is not active yet. Write us (loimichele@gmail.com) for early access.',
...
const de: Catalog = {
  ...
  'wireframe.modal.upsell.parkedNotice': 'Der Pro-Plan ist noch nicht aktiv. Schreiben Sie uns (loimichele@gmail.com) für frühen Zugang.',
...
const fr: Catalog = {
  ...
  'wireframe.modal.upsell.parkedNotice': "Le plan Pro n'est pas encore actif. Écrivez-nous (loimichele@gmail.com) pour un accès anticipé.",
