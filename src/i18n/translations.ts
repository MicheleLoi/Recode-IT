...
const it: Catalog = {
  ...
  'tabs.decodifica.title': 'Incolla la risposta dell’AI e ricevi i nomi reali (€20 una tantum)',
  ...
  'decodifica.locked.description': 'La Decodifica costa €20 una tantum. Una volta sbloccata resta attiva su tutti i browser dove sei autenticato.',
  'decodifica.locked.notLoggedIn': 'Accedi o crea un account: serve un’identità per registrare l’autorizzazione.',
  'decodifica.locked.payCTA': 'Sblocca con €20',
...
const en: Catalog = {
  ...
  'tabs.decodifica.title': 'Paste the AI response and get back real names (€20 one-time)',
  ...
  'decodifica.locked.description': 'Decoding costs €20 one-time. Once unlocked, it stays active on all browsers where you are authenticated.',
  'decodifica.locked.notLoggedIn': 'Sign in or create an account — an identity is required to register the authorisation.',
  'decodifica.locked.payCTA': 'Unlock for €20',
...
const de: Catalog = {
  ...
  'tabs.decodifica.title': 'KI-Antwort einfügen und echte Namen zurückerhalten (20 € einmalig)',
  ...
  'decodifica.locked.description': 'Das Dekodieren kostet einmalig 20 €. Einmal freigeschaltet bleibt es auf allen Browsern aktiv, auf denen Sie angemeldet sind.',
  ...
  'decodifica.locked.payCTA': 'Für 20 € freischalten',
...
const fr: Catalog = {
  ...
  'tabs.decodifica.title': 'Coller la réponse IA et récupérer les vrais noms (20 € unique)',
  ...
  'decodifica.locked.description': 'Le décodage coûte 20 € une seule fois. Une fois débloqué, il reste actif sur tous les navigateurs où vous êtes authentifié.',
  ...
  'decodifica.locked.payCTA': 'Débloquer pour 20 €',
